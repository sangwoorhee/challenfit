...
import { User, UserAfterAuth } from 'src/common/decorators/user.decorator';
  ...
  export class ChatController {
    ...
    @ApiOperation({ 
      ...
      description: 'GET: http://localhost:3000/chat/room/:challengeRoomIdx/messages' 
    })
    async getMessages(
    ...
    @ApiOperation({ 
      ...
      description: 'GET: http://localhost:3000/chat/room/:challengeRoomIdx/messages/export' 
    })
    ...
    @ApiOperation({ 
      ...
      description: 'GET: http://localhost:3000/chat/room/:challengeRoomIdx/online-users' 
    })
    async getOnlineUsers(
      ...
      const onlineUsers = await this.chatService.getRoomOnlineUsersWithProfile(
        challengeRoomIdx,
      );
